...
export const VideoBackground: React.FC<VideoBackgroundProps> = () => {
  ...
  return (
    <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none select-none">
      {/* Video All-Intra 16:9 nativo a 60 FPS para cobertura nítida y scrubbing instantáneo */}
      <video
        ref={videoRef}
        src={dnaVideoUrl}
        playsInline
        ...
        style={{
          opacity: 0.92,
          filter: 'contrast(102%) brightness(101%) saturate(105%)',
          willChange: 'contents',
        }}
      />

      {/* Capa de integración visual estilo Apple: más transparente para máxima inmersión */}
      <div
        className="absolute inset-0"
        style={{
          background:
            'radial-gradient(ellipse at 50% 40%, rgba(251,251,253,0.10) 0%, rgba(251,251,253,0.35) 70%, rgba(245,245,247,0.55) 100%)',
        }}
      />
